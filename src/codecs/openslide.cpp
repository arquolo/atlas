...
OpenSlide::OpenSlide(const std::string& path)
  : Image{path}
  , slide_{nullptr}
  , bg_r_{255}
  , bg_g_(255)
...
std::string OpenSlide::getOpenSlideErrorState() {
...
bool OpenSlide::initializeType(const std::string& imagePath) {
...
std::string OpenSlide::getProperty(const std::string& propertyName) {
...
void* OpenSlide::readDataFromImage(const long long& startX, const long long& startY, const unsigned long long& width,
